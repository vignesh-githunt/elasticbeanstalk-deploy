...
import Avatar from '../../images/user/02.jpg'
    ...
    return (
      <div className="abs-center wd-xl">
        <div className="d-flex justify-content-center">
          <div className="p-2">
            <img className="img-fluid img-thumbnail rounded-circle" src={Avatar} alt="Avatar" width="60" height="60" />
          </div>
        </div>
