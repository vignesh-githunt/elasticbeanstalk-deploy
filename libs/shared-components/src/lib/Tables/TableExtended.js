...
const TableExtended = (props) => {
    ...
    const {listA, listB} = myState;

      // handle global when click on header checkbox
    const handleCheckList=(listName, checkStat) =>{
       setMyState({[listName]: props[listName].map(item => ({...item, checked: checkStat}))})
    }

    const handleCheckListA = e => handleCheckList('listA', e.target.checked)
    const handleCheckListB = e => handleCheckList('listB', e.target.checked)

      // handle particular changes on each checkbox
     const handleChange = (listName, index) => {
      setMyState({ [listName]: props[listName].map((item, i) => (index !== i ? item : {...item, checked: !props[listName][index].checked} ) )})
    }
    return (
        <ContentWrapper>
                        ...
                        <tr>
                            ...
                            <th data-check-all>
                                <div className="checkbox c-checkbox">
                                    <label>
                                        <input type="checkbox" onChange={handleCheckListA}/>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div className="checkbox c-checkbox">
                                    <label>
                                        <input type="checkbox" checked={listA[0].checked} onChange={e => handleChange('listA', 0)}/>
                                        <span className="fa fa-check"></span>
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="checkbox c-checkbox">
                                    <label>
                                        <input type="checkbox" checked={listA[1].checked} onChange={e => handleChange('listA', 1)}/>
                                        <span className="fa fa-check"></span>
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="checkbox c-checkbox">
                                    <label>
                                        <input type="checkbox" checked={listA[2].checked} onChange={e => handleChange('listA', 2)}/>
                                        <span className="fa fa-check"></span>
                                    </label>
                                </div>
                            </td>
                    ...
                    <thead>
                        <tr>
                            <th data-check-all>
                                <div className="checkbox c-checkbox">
                                    <label>
                                        <input type="checkbox" onChange={handleCheckListB}/>
                                        <span className="fa fa-check"></span>
                                    </label>
                                </div>
                            </th>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div className="checkbox c-checkbox">
                                    <label>
                                        <input type="checkbox" checked={listB[0].checked} onChange={e => handleChange('listB', 0)}/>
                                        <span className="fa fa-check"></span>
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div className="checkbox c-checkbox">
                                    <label>
                                        <input type="checkbox" checked={listB[1].checked} onChange={e => handleChange('listB', 1)}/>
                                        <span className="fa fa-check"></span>
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div className="checkbox c-checkbox">
                                    <label>
                                        <input type="checkbox" checked={listB[2].checked} onChange={e => handleChange('listB', 2)}/>
                                        <span className="fa fa-check"></span>
                                    </label>
                                </div>
                            </td>
