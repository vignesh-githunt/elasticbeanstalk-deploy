...
const dtOptions3 = useState({
  ...
  const dtInstance = dtInstance => {
    ...
    columnInputs
        .keyup(function() {
            dtInstance.fnFilter(props.value, columnInputs.index(props));
        });
}
return (
    <ContentWrapper>
