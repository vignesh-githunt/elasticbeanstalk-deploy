    ...
    return (
        <ContentWrapper>
                <div className="content-heading">
                    <div>Forum - Topics
                        <small>Category ID: {params.catid}</small>
                    </div>
                    ...
                    <Table striped>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <h4>
                                        <Link to={`/forum/discussion/${params.catid}/12346`}>
                            ...
                            <tr>
                                <td>
                                    <h4>
                                        <Link to={`/forum/discussion/${params.catid}/23457`}>
                            ...
                            <tr>
                                <td>
                                    <h4>
                                        <Link to={`/forum/discussion/${params.catid}/34568`}>
                            ...
                            <tr>
                                <td>
                                    <h4>
                                        <Link to={`/forum/discussion/${params.catid}/45679`}>
                            ...
                            <tr>
                                <td>
                                    <h4>
                                        <Link to={`/forum/discussion/${params.catid}/567810`}>
                            ...
                            <tr>
                                <td>
                                    <h4>
                                        <Link to={`/forum/discussion/${params.catid}/678911`}>
                            ...
                            <tr>
                                <td>
                                    <h4>
                                        <Link to={`/forum/discussion/${params.catid}/7891012`}>
