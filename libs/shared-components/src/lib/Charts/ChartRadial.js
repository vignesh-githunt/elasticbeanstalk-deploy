...
const ChartRadial=()=>{
    const knobChart1 = useRef();
    const knobChart2 = useRef();
    const knobChart3 = useRef();
    const knobChart4 = useRef();
    const easypie1 = useRef();
    const easypie2 = useRef();
    const easypie3 = useRef();
    const easypie4 = useRef();
    useEffect(()=>{
        ...
        $(knobChart1).knob(knobLoaderOptions1);
        ...
        $(knobChart2).knob(knobLoaderOptions2);
        ...
        $(knobChart3).knob(knobLoaderOptions3);
        ...
        $(knobChart4).knob(knobLoaderOptions4);
        ...
        new EasyPieChart(easypie1.current, pieOptions1);
        ...
        new EasyPieChart(easypie2.current, pieOptions2);
        ...
        new EasyPieChart(easypie3.current, pieOptions3);
        ...
        new EasyPieChart(easypie4.current, pieOptions4);
