...
const FormExtended = (props) => {
    const [displayColorPicker, setDisplayColorPicker] = useState(false);
    const [displayColorPickerInput, setDisplayColorPickerInput] = useState(false);
    const [colorSelected, setColorSelected] = useState('#00AABB');
    ...
    const [editorState, setEditorState] = useState(EditorState.createWithContent(initialEditorContent));


    const colorpickerHandleClick = () => {
    ...
    const colorpickerInputHandleClick = () => {
        setDisplayColorPickerInput(!displayColorPickerInput)
    };

    const colorpickerInputHandleClose = () => {
        setDisplayColorPickerInput(false)
    };
    const sliderLog=(value)=> {
        console.log(value)
    }
    ...
    const handleChangeSelectMulti = (selectedOptionMulti) => {
    ...
    const { selectedOptionMulti } = props;
    // editor
                        ...
                        <form method="get" action="#" className="form-horizontal">
                            <fieldset>
                                ...
                                <div className="form-group row">
                                   ...
                                   <div className="col-md-4">
                                        <p>Basic Slider</p>
                                        <Slider onChange={sliderLog} />
                                        <p className="mt-2">Basic Slider，`step=20`</p>
                                        <Slider step={20} defaultValue={50} onBeforeChange={sliderLog} />
                                        <p className="mt-2">Basic Slider，`step=20, dots`</p>
                                        <Slider dots step={20} defaultValue={100} onAfterChange={sliderLog} />
                                   </div>
                                </div>
                                <div className="form-group row">
                                   ...
                                   <div className="col-md-4">
                                        ...
                                        <Range allowCross={false} defaultValue={[0, 20]} onChange={sliderLog} />
                                        <p className="mt-2">Basic Range，`step=20` </p>
                                        <Range step={20} defaultValue={[20, 40]} onBeforeChange={sliderLog} />
                                        <p className="mt-2">Basic Range，`step=20, dots` </p>
                                        <Range dots step={20} defaultValue={[20, 40]} onAfterChange={sliderLog} />
                                   </div>
                                </div>
                                <div className="form-group row">
                                        ...
                                        <div className="row">
                                            <div className="col-md-4">
                                                ...
                                                <div className="mb-3" style={{height: 400}}>
                                                    <Slider vertical min={-10} marks={marks} step={null} onChange={sliderLog} defaultValue={20} />
                                                </div>
                                            </div>
                                            <div className="col-md-4">
                                                <p className="mt-2">Slider with marks and steps</p>
                                                <div className="mb-3" style={{height: 400}}>
                                                    <Slider vertical dots min={-10} marks={marks} step={10} onChange={sliderLog} defaultValue={20} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <Col sm={ 8 }>
                                        <Row>
                                            <Col xs={ 12 }>
                                                ...
                                                <button type="button" className="btn btn-secondary" onClick={ colorpickerHandleClick }>Pick Color</button>
                                                { displayColorPicker ? <div style={ popover }>
                                                  <div style={ cover } onClick={ colorpickerHandleClose }/>
                                                  <ChromePicker />
                                                </div> : null }
                                            </Col>
                                            <Col xs={ 12 }>
                                                ...
                                                <InputGroup className="colorpicker-component demo-colorpicker">
                                                    <Input value={colorSelected} onChange={()=>{}} onFocus={ colorpickerInputHandleClick }/>
                                                    <InputGroupAddon addonType="append">
                                                        <InputGroupText><i className="icon-pin"></i></InputGroupText>
                                                    </InputGroupAddon>
                                                </InputGroup>
                                                { displayColorPickerInput ? <div style={ popover }>
                                                  <div style={ cover } onClick={ colorpickerInputHandleClose }/>
                                                  <SketchPicker color={colorSelected} onChange={color => setColorSelected(color.hex)}/>
                                                </div> : null }
                                            </Col>
                            ...
                            <fieldset>
                                <div className="form-group row">
                                    ...
                                    <Col md={ 10 }>
                                        <p>Card Number:{' '}</p>
                                        <MaskedInput className="form-control" mask="1111 1111 1111 1111" name={card} size="20"   onChange={e => setCard(e.target.value)}/>
                                        <p className="mt-2">Expiry Date:{' '}</p>
                                        <MaskedInput className="form-control" mask="11/1111" name={expiry} placeholder="mm/yyyy"   onChange={e => setExpiry(e.target.value)}/>
                                        <p className="mt-2">CCV:{' '}</p>
                                        <MaskedInput className="form-control" mask="111" name={ccv}   onChange={e => setCcv(e.target.value)}/>
                                        <p className="mt-2">Escaped:</p>
                                        <MaskedInput className="form-control" mask="11 \* 11" name={escaped} id="escaped"   onChange={e => setEscaped(e.target.value)}/>
                                        ...
                                        <MaskedInput className="form-control" mask="(0) 111 1111" name={leading} id="leading"   onChange={e => setLeading(e.target.value)}/>
