            ...
            <Card>
                <form className="ie-fix-flex">
                    <div role="tabpanel">
                        <Nav tabs justified>
                            <NavItem>
                                <NavLink href="#edit" className={ activeTab === 'edit' ? 'active':'' }
                                        onClick={() => { toggleTab('edit'); }}
                                >
                                    Product Edit</NavLink>
                            </NavItem>
                            <NavItem>
                                <NavLink href="#seo" className={ activeTab === 'seo' ? 'active':'' }
                                        onClick={() => {toggleTab('seo'); }}
                                >
                                    SEO Metadata</NavLink>
                            </NavItem>
                            <NavItem>
                                <NavLink href="#picture" className={ activeTab === 'picture' ? 'active':'' }
