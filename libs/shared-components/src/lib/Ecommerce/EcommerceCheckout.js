...
const EcommerceCheckout = () => {
    const INITIAL_STATE = {oneAtATime : true,accordionState :[true, false, false, false, false, false]}
                                        ...
                                        <CardBody id="collapse01">
                                            <Row>
                                                <Col lg="6">
                                                    ...
                                                    <div className="my-3">
                                                        <button className="btn btn-primary" type="button" onClick={() => toggleAccordion(1)}>Register</button>
                                                    </div>
                                                    <hr className="my-4"/>
                                                    <button className="btn btn-secondary" type="button" onClick={() => toggleAccordion(1)}>Checkout as Guest</button>
                                                </Col>
                                                <Col lg="6">
                                        ...
                                        <CardBody id="collapse02">
                                            ...
                                            <div className="pt-2 clearfix">
                                                ...
                                                <div className="float-left">
                                                    <button className="btn btn-primary" type="button" onClick={() => toggleAccordion(2)}>Continue</button>
                                                </div>
                                            </div>
                                        </CardBody>
                                    </Collapse>
                                    ...
                                    <Collapse isOpen={accordionState[2]}>
                                        <CardBody id="collapse03">
                                            ...
                                            <div className="pt-2 clearfix">
                                                ...
                                                <div className="float-left">
                                                    <button className="btn btn-primary" type="button" onClick={() => toggleAccordion(3)}>Continue</button>
                                                </div>
                                            </div>
                                        </CardBody>
                                    </Collapse>
                                ...
                                <div className="card b mb-2">
                                    ...
                                    <Collapse isOpen={accordionState[3]}>
                                        <CardBody id="collapse04">
                                            ...
                                            <div className="pt-2 clearfix">
                                                <div className="float-left">
                                                    <button className="btn btn-primary" type="button" onClick={() =>toggleAccordion(4)}>Continue</button>
                                                </div>
                                            </div>
                                        </CardBody>
                                    </Collapse>
                                    ...
                                    <Collapse isOpen={accordionState[4]}>
                                        <CardBody id="collapse05">
                                            ...
                                            <div className="pt-2 clearfix">
                                                ...
                                                <div className="float-left">
                                                    <button className="btn btn-primary" type="button" onClick={() => toggleAccordion(5)}>Continue</button>
                                                </div>
                                            </div>
                                        </CardBody>
                                    </Collapse>
                                ...
                                <div className="card b mb-2">
                                    ...
                                    <Collapse isOpen={accordionState[5]}>
                                        <CardBody id="collapse06">
                                            ...
                                            <div className="mt-3">
                                                <button className="btn btn-info" type="button" onClick={() => toggleAccordion(0)}>Submit Order</button>
                                            </div>
                                        </CardBody>
                                    </Collapse>
                                </div>
