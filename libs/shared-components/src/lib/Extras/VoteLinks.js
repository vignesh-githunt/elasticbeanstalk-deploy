...
const VoteCard = (props) => {
    ...
    const sumVote = () => setVotes(votes + 1)
    const subVote = () => setVotes(votes - 1)
                ...
                <tbody>
                    <tr>
                        <td className="b0 wd-xxs text-center">
                            <p>
                                <button type="button" className="btn btn-link" onClick={sumVote}>
                                    <em className="fa fa-angle-up fa-lg"></em>
                                </button>
                            </p>
                            <p>{votes}</p>
                            <p className="mb-0" >
                                <button type="button" className="btn btn-link" onClick={subVote}>
                        ...
                        <td className="b0">
                            <p className="h4 mt-0">
                                <span className="rounded badge bg-gray-lighter px-4 mr-2 text-sm d-none d-lg-inline">
                                    <span className="text-muted">{props.topic}</span>
                                </span>
                            ...
                            <div className="text-sm text-muted">
                                ...
                                <br/>{props.posted}
                                <span> - </span>
                                <a className="text-bold" href="#author">{props.author}</a>
                            </div>
                        </td>
                    </tr>
                </tbody>
