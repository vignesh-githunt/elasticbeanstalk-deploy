...
import { Logo, LogoSmall, ToggleFullscreen } from "@nextaction/components";
      ...
      <div className="navbar-header">
            <a className="navbar-brand" href="#/">
              <div className="brand-logo">
                <img src={Logo} className='img-fluid' title="TruStories - Automated Sales Development" width={200} />
              </div>
