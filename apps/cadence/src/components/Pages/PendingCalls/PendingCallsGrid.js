...
function PendingCallsGrid({
  ...
  useEffect(
    () => {
      selectedRowCount(Object.keys(selectedRowIds).length)
    }, [selectedRowIds]
  );
                  ...
                  <tr>
                    <td colSpan="7">
                      <Alert color="danger" className="text-center" role="alert">
                        <h4>
                          <i className="fas fa-exclamation-circle fa-lg mr-2"></i>No Pending Calls Available
                        </h4>
                      </Alert>
                    </td>
                  </tr>
