...
const Calls = ({location,match}) => {
  ...
  const [prospectsFilter, setProspectsFilter] = useState(`&filter[user][id]=${currentUserId}&filter[cadence][id]=${cadenceID}&filter[currentTouchType]=CALL`);
